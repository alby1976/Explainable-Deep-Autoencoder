...
PATH_TO_DATA_GENE_NAME = './gene_name_QC.txt'    # path to cleaned x with gene annotation (not gene id) (after quatlity control)
...
for i in range(column_num):
  ...
  #explainer = shap.KernelExplainer(my_model.predict,x = X_test) # different SHAP explainer could be used
