...
def process_shap_values(save_bar: Path, save_scatter: Path, gene_model: Path, model_name: str, x_test, shap_values,
    ...
    # generate bar char
    plot_shap_values(model_name, node, shap_values, x_test, gene_names, "bar", (30, 40), save_bar)  # (width, height)
    # generate scatter chart
    plot_shap_values(model_name, node, shap_values, x_test, gene_names, "dot", (30, 40), save_scatter)
